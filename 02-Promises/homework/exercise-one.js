...
function problemC () {
 ...
 // });
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then(lectura2 => {
    blue(lectura2)
    return promisifiedReadFile('poem-one/stanza-03.txt').then((lectura3) => blue(lectura3) )
  })
...
function problemD () {
 ...
 // });
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-04.txt').then(stanza4 => blue(stanza4)
...
function problemF () {
 ...
 // });
  ...
  promisifiedReadFile('poem-one/stanza-03.txt').then(lecturaStanza3 => {
    blue(lecturaStanza3)
    return promisifiedReadFile('poem-one/stanza-04.txt').then(lectura4 => {
blue(lectura4)
    }).catch(err => magenta(new Error(err)))
    .finally(() => {
      console.log("done")
